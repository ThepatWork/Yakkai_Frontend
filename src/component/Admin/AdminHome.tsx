        ...
        <center>
            <div style={{ height: 'auto', width: '95%', backgroundColor: '#ffffff99' }} className='contentPage'>
                ...
                <div className='container_admin_home'>
                    ...
                    <div id="menu_admin_1" className='menu_admin' onClick={() => navigate('/AdminCheckProduct')}>
                    ...
                    <div id="menu_admin_2" className='menu_admin' onClick={() => navigate('/AdminCheckAds')}>
                    ...
                    <div id="menu_admin_3" className='menu_admin' onClick={() => navigate('/CheckFraudReport')}>
                    ...
                    <div id="menu_admin_3" className='menu_admin' onClick={() => navigate('/AdminManagement')}>
                    ...
                    <div id="menu_admin_4" className='menu_admin' onClick={() => navigate('/DataWeb')}>
                    ...
                    <div id="menu_admin_5" className='menu_admin'onClick={() => navigate('/AdminCategory')}>
                    ...
                    <div id="menu_admin_6" className='menu_admin' onClick={() => navigate('/AdminTopBanner')}>
                    ...
                    <div id="menu_admin_6" className='menu_admin' onClick={() => navigate('/HomePage')}>
